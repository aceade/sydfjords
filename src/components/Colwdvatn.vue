...
<template>
    <div id="container">
        <h1>Colwdvatn</h1>
        <p class="blurb">The heart of the Sydfjords</p>

        <img srcset="/sydfjords/town-480w.webp 480w, /sydfjords/town-800w.webp 800w, /sydfjords/town-1080w.webp 1080w, /sydfjords/town-1366w.webp 1366w, /sydfjords/town-1920w.webp 1920w"
    sizes="(max-width: 600px) 480px, (max-width: 900px) 800px, 1366px, 1920px" alt="Town">
        ...
        <img loading="lazy" srcset="/sydfjords/town2-480w.webp 480w, /sydfjords/town2-800w.webp 800w, /sydfjords/town2-1080w.webp 1080w, /sydfjords/town2-1366w.webp 1366w, /sydfjords/town2-1920w.webp 1920w"
    sizes="(max-width: 600px) 480px, (max-width: 900px) 800px, 1366px, 1920px" alt="Town">
    </div>
</template>
